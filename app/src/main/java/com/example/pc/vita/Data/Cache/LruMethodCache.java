 ...
 */
public abstract class LruMethodCache<K,V> implements CacheInterface<K,V>{
    ...
    public LruMethodCache() {
        this(DEFAULT_CAPACITY);
    }

    public LruMethodCache(int capacity) {
        if (capacity <= 0) {
    ...
    protected String getClassName() {
        return LruMethodCache.class.getName();
    }
